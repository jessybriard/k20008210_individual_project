...
class TestLabeledDataBuilderBalanceData(TestCase):
    ...
    def test_undersample_no_label_column_in_labeled_data(self):
        ...
        self.assertEqual("The given labeled_data does not contain a 'label_classification' column.", str(e.exception))
    ...
    def test_undersample_empty_labeled_data(self):
        ...
        # Arrange
        labeled_data = pd.DataFrame(data={"Date": [], "features": [], "label_classification": []}).set_index("Date")

        # Act
        balanced_data = undersample(labeled_data=labeled_data)

        # Assert
        expected_balanced_data = pd.DataFrame(data={"Date": [], "features": [], "label_classification": []}).set_index(
            "Date"
        )
    ...
    def test_undersample_single_class(self):
        ...
        labeled_data = pd.DataFrame(
            data={
                ...
                "label_classification": [False, False],
            }
        ).set_index("Date")
    ...
    def test_undersample_equal_distribution(self):
        ...
        labeled_data = pd.DataFrame(
            data={
                ...
                "label_classification": [False, False, True, True],
            }
        ).set_index("Date")
    ...
    def test_undersample_more_true(self):
        ...
        labeled_data = pd.DataFrame(
            data={
                ...
                "label_classification": [True, False, True, True],
            }
        ).set_index("Date")
        ...
        # Assert
        self.assertEqual({True: 1, False: 1}, dict(Counter(balanced_data["label_classification"].values)))
    ...
    def test_undersample_more_false(self):
        ...
        labeled_data = pd.DataFrame(
            data={
                ...
                "label_classification": [True, False, False, False],
            }
        ).set_index("Date")
